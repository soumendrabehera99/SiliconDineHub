<!-- footer section -->
    <footer class="footer_section text-center text-white bg-dark mt-4 w-100" id="footer">
      <div class="container">
        <div class="row g-5">
          <div class="col-md-3">
          ...
          <div class="col-md-3">
            <div class="footer_detail">
              <a href="" class="footer-logo"> Silicon DineHub </a>
              <p>
                Fresh coffee, tasty snacks, and wholesome meals await you. Open
                daily stop by and fuel your day!
              </p>
          ...
          <div class="col-md-3">
              <h4>Opening Hours</h4>
              <div class="row g-0 m-2 text-start">
